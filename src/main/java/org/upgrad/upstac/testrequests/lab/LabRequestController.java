...
public class LabRequestController {
    ...
    @GetMapping
    @PreAuthorize("hasAnyRole('TESTER')")
    //getForTester method run and return the testrequest list for the logged in Tester.
    ...
    //assignForLabTest is used to assign the selected testRequest ID to the logged in tester for updation of tes parameters
    ...
    //updateLabTest method is used by tester to update the testrequest parameters
